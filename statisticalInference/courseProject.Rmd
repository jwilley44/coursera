...
We can see from the plot the means are normally distributed. The scatter plot below takes quantiles fromt the distribution of means and plots them against quantiles for a normal distribution with mean 5 and standard deviation 0.791. This plot also shows that the means follow a normal distribution.
