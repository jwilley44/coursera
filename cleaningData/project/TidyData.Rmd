...
```
./run_analysis.R <location of original data>
```
This will create a directory called tidyData in the same parent directory as the directory with the original data with two files:    
